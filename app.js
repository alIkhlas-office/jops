...
(function () {
  ...
  const FORMS = {
    ...
    private_trip_owner: {
      title: "سجّل عربيتك للمشاوير الخاصة",
      subtitle: "عندك عربية وعايز تشتغل بيها مشاوير خاصة؟ سجّل بياناتك وفريقنا يوصّلك بالعملاء.",
      badge: "🚘 صاحب سيارة مشاوير",
      fields: [
        { name: "full_name", label: "الاسم بالكامل", type: "text", required: true, ph: "مثال: أحمد محمود" },
        { name: "phone", label: "رقم الموبايل", type: "tel", required: true, ph: "01xxxxxxxxx", pattern: "01[0-9]{9}", hint: "رقم مصري مكوّن من 11 رقم" },
        { name: "whatsapp", label: "رقم واتساب (إن وجد)", type: "tel", ph: "01xxxxxxxxx" },
        { type: "location", required: true },
        { name: "car_type", label: "نوع السيارة", type: "select", required: true, options: [
          { v: "ملاكي", t: "ملاكي" },
          { v: "SUV", t: "SUV / دفع رباعي" },
          { v: "فان", t: "فان" },
          { v: "ميكروباص", t: "ميكروباص" },
          { v: "سيارة فاخرة", t: "سيارة فاخرة / VIP" },
        ]},
        { name: "car_model", label: "الماركة / الموديل", type: "text", ph: "مثال: تويوتا كورولا 2020" },
        { name: "drive_mode", label: "طريقة التشغيل", type: "select", required: true, options: [
          { v: "أنا السائق", t: "أنا السائق (أشغّل عربيتي بنفسي)" },
          { v: "عندي سائق", t: "عندي سائق يشغّلها" },
          { v: "بدون سائق", t: "أأجّرها بدون سائق" },
        ]},
        { name: "service_types", label: "أنواع المشاوير اللي تفضّلها", type: "select", required: true, options: [
          { v: "داخل المدينة", t: "داخل المدينة" },
          { v: "بين المحافظات", t: "بين المحافظات" },
          { v: "مطارات", t: "مطارات" },
          { v: "يومي / متكرر", t: "يومي / متكرر" },
          { v: "مشاوير شركات", t: "مشاوير شركات" },
          { v: "كل الأنواع", t: "كل الأنواع" },
        ]},
        { name: "availability", label: "متاح للتشغيل", type: "select", options: [
          { v: "متاح فورًا", t: "متاح فورًا" },
          { v: "أوقات محددة", t: "أوقات محددة" },
          { v: "حسب الاتفاق", t: "حسب الاتفاق" },
        ]},
        { name: "expected_income", label: "الدخل المتوقع (جنيه/شهريًا)", type: "number", min: 0, ph: "مثال: 12000", hint: "اختياري — يساعدنا في ترشيح الفرص المناسبة" },
        { name: "notes", label: "ملاحظات إضافية", type: "textarea", full: true, ph: "حالة السيارة، المناطق اللي بتغطيها، أي تفاصيل..." },
      ],
    },
